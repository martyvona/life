    ...
    window.onload = function()
    {
        ...
        if(parameters["noui"] === "1")
        {
            var elements = [
                ...
                "step_button", "rewind_button", "randomize_button",
                "export_button", "run_button", "normalspeed_button",
                "slower_button", "faster_button", "initial_pos_button",
                "nw_button", "n_button", "ne_button",
                "w_button", "middle_button", "e_button",
                "sw_button", "s_button", "se_button"
    ...
    function run()
    {
        ...
        function draw()
        {
            ...
            if(Date.now() - last_frame_ms >= ms_per_frame)
            {
                ...
                var avg_step_period_ms = total_steps > 0 ? ((now_ms - start_ms) / total_steps) : 0;
                update_hud(1000 / last_frame_period_ms, avg_step_period_ms > 0 ? (1000 / avg_step_period_ms) : 0);
            }
        ...
        function update()
        {
            ...
            while((total_steps < (now_ms - start_ms) / ms_per_step) && (Date.now() - now_ms <= ms_per_step))
            {
                life.next_step(true);
